...
cp -r build/DA2_esp_LAN.bin /mnt/c/embedded/esp_flash_folder/da2_esp_LAN
cp -r build/bootloader/bootloader.bin /mnt/c/embedded/esp_flash_folder/da2_esp_LAN
cp -r build/partition_table/partition-table.bin /mnt/c/embedded/esp_flash_folder/da2_esp_LAN
