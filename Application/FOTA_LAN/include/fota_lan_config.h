...
#define FOTA_CONFIG_LAN_TB_HOST             "192.168.0.224"
...
#define FOTA_CONFIG_LAN_TB_DEVICE_TOKEN     "CHANGE_ME_DEVICE_TOKEN_LAN"
...
#define FOTA_CONFIG_LAN_TB_FIRMWARE_VERSION "1.1.1"
